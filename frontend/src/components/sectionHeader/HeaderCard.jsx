...
function HeaderCard() {
  return (
    <div className={HeaderCardCSS.headerCardContainer}>
      ...
      <h2>
        Dzięki SoGood Rentals możesz wypożyczyć wymarzony luksusowy samochód
        wybrany z obszernej floty w kilka minut.
      </h2>
      <ButtonMultipurpose to="offer">Przejrzyj flotę</ButtonMultipurpose>
    </div>
  );
}
