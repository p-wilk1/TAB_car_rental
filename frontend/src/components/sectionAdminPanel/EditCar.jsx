                ...
                {loading ?(
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className={styles.row}>
                            ...
                            <br />
                            <select id={office} value={car.office.officeName} onChange={handleOfficeChange} >
                        ...
                        <div className={styles.row}>
                            <div className={styles.column1of2}>
                                ...
                                <br />
                                <select id={seatsNumber} value={car.carInfo.seatsNumber} onChange={handleSeatsNumberChange} >
                            ...
                            <div className={styles.column1of2}>
                                ...
                                <br />
                                <select id={doorsNumber} value={car.carInfo.doorsNumber} onChange={handleDoorsNumberChange} >
                                    <option value="2">2</option>
                        ...
                        <div className={styles.row}>
                            <div className={styles.column1of2}>
                                ...
                                <br />
                                <select id={gearboxType} value={car.carInfo.gearboxType} onChange={handleGearboxTypeChange} >
                        ...
                        <div className={styles.row}>
                            ...
                            <div className={styles.column1of2}>
                                ...
                                <br />
                                <select id={fuelType} value={car.carInfo.fuelType} onChange={handleFuelTypeChange} >
